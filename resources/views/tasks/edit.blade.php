        ...
        <form method="POST" action="{{ route('tasks.update', $task->id) }}" enctype="multipart/form-data">
            ...
            <div>
                ...
                <select name="urban_farmer" id="urban_farmer" class="rounded-md shadow-sm border-gray-300 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 block mt-1 w-full">
                    ...
                    @if ($urban_farmer->id == $task->urban_id)
            ...
            <div class="mt-4">
                ...
                <x-input id="title" class="block mt-1 w-full" type="text" name="title" value="{{ $task->title }}" placeholder="{{ $task->title }}" required autofocus />
            </div>
            ...
            <div class="mt-4">
                ...
                <x-textarea id="description" class="block mt-1 w-full" type="text" name="description" value="{{ $task->description }}" autofocus>{{ $task->description }}</x-textarea>
            </div>
            ...
            <div class="mt-4">
                ...
                <x-input id="date" class="block mt-1 w-full" type="date" name="date" value="{{ $task->date }}" required />
            </div>
